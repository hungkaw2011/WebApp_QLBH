...
namespace WebApp.DataAccess.Migrations
{
    ...
    [Migration("20230423204546_AddProduct")]
            ...
            modelBuilder.Entity("WebApp.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDateTime = new DateTime(2023, 4, 24, 3, 45, 45, 977, DateTimeKind.Local).AddTicks(5625),
                            DisplayOrder = 1,
                            Name = "Action"
                        },
                        new
                        {
                            Id = 2,
                            CreatedDateTime = new DateTime(2023, 4, 24, 3, 45, 45, 977, DateTimeKind.Local).AddTicks(5638),
                            DisplayOrder = 2,
                            Name = "Scifi"
                        },
                        new
                        {
                            Id = 3,
                            CreatedDateTime = new DateTime(2023, 4, 24, 3, 45, 45, 977, DateTimeKind.Local).AddTicks(5640),
                            DisplayOrder = 3,
                            Name = "History"
                        });
                });
